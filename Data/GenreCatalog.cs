...
public static class GenreCatalog {
	...
	static GenreCatalog() {
		...
		Add("traditional-pop", Genre.TraditionalPop, GenreFamily.Pop, 1950, 1971, .15f, .45f, .90f,.75f,.50f,.40f,.35f,.32f,.30f);
		Add("teen-pop", Genre.TeenPop, GenreFamily.Pop, 1957, 1965, .90f, .90f, .70f,.75f,.50f,.35f,.30f,.28f,.25f);
		Add("baroque-pop", Genre.BaroquePop, GenreFamily.Pop, 1966, 1970, .60f, .50f, .02f,.02f,.10f,.50f,.65f,.55f,.45f);
		Add("sunshine-pop", Genre.SunshinePop, GenreFamily.Pop, 1965, 1971, .65f, .55f, .02f,.05f,.20f,.55f,.70f,.60f,.50f);
		Add("bubblegum", Genre.Bubblegum, GenreFamily.Pop, 1967, 1971, .95f, .90f, .01f,.02f,.05f,.20f,.40f,.65f,.60f);
		Add("easy-listening", Genre.EasyListening, GenreFamily.Pop, 1950, null, .15f, .35f, .80f,.70f,.55f,.60f,.60f,.55f,.55f);
		Add("british-pop", Genre.BritishPop, GenreFamily.Pop, 1964, 1968, .90f, .80f, .01f,.02f,.80f,.75f,.55f,.40f,.30f);
		Add("rock-and-roll", Genre.RockAndRoll, GenreFamily.Rock, 1955, null, .85f, .85f, .60f,.65f,.50f,.40f,.35f,.35f,.35f);
		...
		Add("psychedelic-rock", Genre.PsychedelicRock, GenreFamily.Rock, 1966, 1971, .85f, .45f, .02f,.02f,.10f,.50f,.85f,.75f,.65f);
		Add("acid-rock", Genre.AcidRock, GenreFamily.Rock, 1966, 1971, .85f, .40f, .02f,.02f,.05f,.30f,.65f,.70f,.65f);
		...
		Add("blues-rock", Genre.BluesRock, GenreFamily.Rock, 1966, null, .80f, .45f, .02f,.05f,.15f,.45f,.60f,.70f,.70f);
		...
		Add("british-blues", Genre.BritishBlues, GenreFamily.Rock, 1964, null, .85f, .65f, .01f,.02f,.60f,.70f,.65f,.60f,.55f);
		Add("rnb", Genre.RnB, GenreFamily.RhythmAndSoul, 1949, 1965, .70f, .80f, .40f,.50f,.55f,.45f,.40f,.35f,.30f);
		Add("soul", Genre.Soul, GenreFamily.RhythmAndSoul, 1961, null, .75f, .70f, .20f,.55f,.75f,.85f,.90f,.90f,.90f);
		...
		Add("gospel", Genre.Gospel, GenreFamily.Gospel, 1950, null, .50f, .50f, .35f,.35f,.35f,.40f,.45f,.45f,.50f);
		Add("country", Genre.Country, GenreFamily.Country, 1950, null, .40f, .65f, .65f,.60f,.55f,.55f,.55f,.55f,.60f);
		...
		Add("jazz", Genre.Jazz, GenreFamily.Jazz, 1945, null, .35f, .30f, .50f,.45f,.40f,.40f,.40f,.40f,.40f);
		...
		Add("classical", Genre.Classical, GenreFamily.Classical, 1945, null, .20f, .15f, .30f,.30f,.30f,.30f,.30f,.30f,.30f);
